...
export const PopoverComponent = () => {
  const popoverCode = `<Popover id="jhqD0555" control={<Icon glyph="cart" size="xl" />}>
  <Menu>
...
<Popover id="jhqD0556" alignment="right" control={<Image size="m" type="circle" photo="https://placeimg.com/400/400/nature" />}>
<Menu>
...
<Popover id="jhqD0557" control={<Identifier size="m" glyph="money-bills" color={6} />} noArrow>
<Menu>
...
<Popover id="jhqD0558" control={<Icon glyph="menu2" size="xl" />} alignment="right" noArrow>
<Menu>
    ...
    <div>
      ...
      <DocsTile centered>
        <div className="fd-doc__margin--popover">
          <Popover id="jhqD0555" control={<Icon glyph="cart" size="xl" />}>
            <Menu>
              <MenuItem key="1">Option 1</MenuItem>
              <MenuItem key="2">Option 2</MenuItem>
              <MenuItem key="3">Option 3</MenuItem>
