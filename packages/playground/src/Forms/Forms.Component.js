...
`;
  ...
  return (
    <div>
      <Header>Forms</Header>
      <Description>Form elements include field layout, checkboxes, radio buttons and states of a field. Use these components along with inline help and error state.</Description>
      ...
      <Properties
        ...
        properties={[
          {
            name: 'isCheck',
            description: "bool - used in FormItem. When set to 'true', renders an input with type of checkbox."
          },
          {
            name: 'isInline',
            description: "bool - used in FormItem. Set to 'true' to display radio buttons and checkboxes in a row."
          },
          {
            name: 'required',
          ...
          {
            name: 'type',
            description: "string - when used in FormMessage this property sets the type of the message. The options include 'error', 'warning', and 'help'."
          },
          {
            name: 'state',
            description:
      ...
      <Description>
        Help elements give the user information about the input. Two types of help elements can be used. <br />- The inline help element is displayed as a ? Icon. On hover or
        click, help content is displayed. <br />- Help content can also be visible at all times to avoid mistakes. This type of help generally contains validation rules about the
        data allowed in the input field. An example is “Maximum 20 characters”. This is displayed below the input field.
      </Description>
      <DocsTile>
        <FormSet>
          <FormItem>
            <FormLabel htmlFor="input-4">
              Input with inline help
              <span className="fd-inline-help fd-has-float-right">
                <span className="fd-inline-help__content fd-inline-help__content--bottom-right">Lorem ipsum dolor sit amet, consectetur adipiscing.</span>
              </span>
            </FormLabel>
            <FormInput type="text" id="input-4" />
          </FormItem>
      ...
      <Description>
        ...
        <br />- <strong>Normal</strong>: The field is editable but no validation has occurred. <br />- <strong>Valid</strong>: The data format entered has been validated and it’s
        correct, such as an email address. <br />- <strong>Invalid</strong>: The data entered is not valid and must be corrected. <br />- <strong>Warning</strong>: The data entered
        is formatted correctly but there are other issues are problematic but will not stop the user from moving forward. <br />- <strong>Disabled</strong>: This indicates the
        field is not editable. A common use case is that this field is dependent on a previous entry or selection within the form. <br />- <strong>Read Only</strong>: Used to
        display static information in the context of a form. <br />
      ...
      <h2>Radio buttons</h2>
      <Description>
        Radio buttons allow the user to see all options and select one. Generally, this is used when there are between 2-3 options. This component can also be disabled and
        displayed in a row.
      </Description>
      ...
      <DocsTile>
        <FormFieldset>
          ...
          <Radio.RadioGroup name="radio-1" title="general Radio">
            <Radio value="radio-1">Option 1</Radio>
            <Radio value="radio-2">Option 2</Radio>
            <Radio value="radio-3">Option 3</Radio>
          </Radio.RadioGroup>
          <br />
          <Radio.RadioGroup name="radio-2" title="default selection" defaultValue="radio-1">
            <Radio value="radio-1">Option 4</Radio>
            <Radio value="radio-2">Option 5</Radio>
            <Radio value="radio-3">Option 6</Radio>
          </Radio.RadioGroup>
        </FormFieldset>

        <FormFieldset>
          <FormLegend>Radio buttons disabled</FormLegend>
          <Radio.RadioGroup name="radio-3" title="disabled Radio" disabled>
            <Radio value="radio-1">Option 1</Radio>
            <Radio value="radio-2">Option 2</Radio>
            <Radio value="radio-3">Option 3</Radio>
          </Radio.RadioGroup>
        ...
        <FormFieldset>
          <FormLegend>Inline Radio buttons</FormLegend>
          <Radio.RadioGroup name="radio-4" title="inline radio" direction="horizental" defaultValue="radio-1">
            <Radio value="radio-1">Option 7</Radio>
            <Radio value="radio-2">Option 8</Radio>
            <Radio value="radio-3">Option 9</Radio>
          </Radio.RadioGroup>
        </FormFieldset>
      </DocsTile>
