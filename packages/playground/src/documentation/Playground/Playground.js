...
export class Playground extends Component {
  ...
  updateComponent(event) {
    ...
    if (event.target.name in this.state.childs && !(this.state.childs.children instanceof Array || this.state.childs.children instanceof Object)) {
  ...
  render() {
    ...
    switch (this.props.component) {
      case 'alert':
        componentToGenerate = (
          <Alert type={this.state.childs.type} dismissable={this.state.childs.dismissable} link={this.state.childs.link} linkText={this.state.childs.linkText}>
      ...
      case 'dropdown':
        componentToGenerate = (
          <Dropdown
            buttonText={this.retrieveValue('buttonText', this.state.childs.buttonText, this.state.currentValues)}
            buttonIcon={this.retrieveValue('buttonIcon', this.state.childs.buttonIcon, this.state.currentValues)}
      ...
      case 'identifier':
        componentToGenerate = (
          <Identifier
            ...
            glyph={this.retrieveValue('children', '', this.state.currentValues) === '' ? this.state.childs.glyph : null}
          >
        ...
        break;
      case 'image':
        componentToGenerate = <Image size={this.state.childs.size} type={this.state.childs.type} photo={this.state.childs.photo} />;
        break;
      case 'tabs':
        componentToGenerate = (
          <Tabs>
          ...
          <ListGroup>
            <ListGroupItem>
              ...
              <ListGroupItemActions>
                <Button option="light" glyph={this.retrieveValue('glyph', this.state.childs.children.props.children[1].props.children.props.glyph, this.state.currentValues)} />
              </ListGroupItemActions>
            </ListGroupItem>
          </ListGroup>
        );
