...
import { InlineHelp } from '@jay.wang/fundamental-react';
...
export const InlineHelpComponent = () => {
  ...
  const defaultSpreadPlacement = '<InlineHelp text="Lorem ipsum dolor sit amet, consectetur adipiscing." defaultSpread />';
  ...
  return (
    <div>
      ...
      <Properties
        ...
        properties={[
          ...
          },
          {
            name: 'placement',
            description:
              "string (required) - Location for where to display the inline help pop-up. Options include:  'bottom-right', 'bottom-left', 'bottom-center', 'right', and 'left' "
          }
        ]}
      />
      ...
      <h2>spread text</h2>
      <DocsTile centered>
        <InlineHelp text="Lorem ipsum dolor sit amet, consectetur adipiscing." defaultSpread />
      </DocsTile>
      <DocsText>{defaultSpreadPlacement}</DocsText>
      <Separator />
    </div>
  );
};
