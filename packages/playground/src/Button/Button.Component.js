...
<Button isCompact>isCompact</Button>`;
...
<ButtonGroup>
    <Button isCompact>Left</Button>
    <Button isCompact selected>Middle</Button>
    <Button isCompact>Right</Button>
</ButtonGroup>`;
  ...
  return (
    <div>
      ...
      <Description>
        ...
        Color is also important. For instance, the most important button has a blue background where as a red button should only be used if the action it performs is potentially
        destructive.
      </Description>
      ...
      <Properties
        ...
        properties={[
          {
            name: 'option',
            description: "string - indicates the importance of the button. Options include 'emphasized' and 'light'. Leave empty for default."
          },
          {
            name: 'type',
            description: "string - the type of the button. Options include 'standard', 'positive', 'medium', and 'negative'. Leave empty for default/action button."
          },
          {
            name: 'isCompact',
          ...
          {
            name: 'glyph',
            description: 'string - the icon to include in the button. See the icon page for the list of icons.'
          },
          {
            name: 'disabled',
            description: 'bool - disabled state of the button. Enabled by setting disabled property to true.'
          },
          {
            name: 'selected',
            description: 'bool - selected state of the button. Enabled by setting selected property to true.'
          },
      ...
      <Description>
        ...
        <strong>- Emphasized Button</strong>: There should only be one highlighted button on the page. This is the primary call to action. <br />
        <strong>- Regular Button</strong>: The default button style and the most common button. There may be more than one on a page. <br />
        <strong>- Light Button</strong>: This is the lowest priority button and most often used with page content like appearing in a table or list. There may be more than one on
        the page.
      </Description>
      <DocsTile centered>
        <div className="fd-doc__margin--button">
          ...
          <Button onClick={() => clickBtnHandler('Regular')}>Regular Button</Button>
          <Button option="light" onClick={() => clickBtnHandler('Light')}>
            Light Button
          </Button>
        </div>
      </DocsTile>
      ...
      <Description>
        Button can have an icon with text or just and icon. You can use <code> glyph="icon-name"</code> to attach an icon to the button.
      </Description>
      <DocsTile centered>
        <div className="fd-doc__margin--button">
          <Button option="emphasized" glyph="cart">
      ...
      <h2>Button Sizes</h2>
      <Description>
        There are two sizes. The <code>compact</code> size is only used on desktop and it is full size when used on a touch device.
      </Description>
      <DocsTile centered>
        <div className="fd-doc__margin--button">
      ...
      >
        <Button type="standard" glyph="" option="light" isCompact={false} selected={false} disabled={false}>
          BUTTON
        </Button>
      </Playground>
    </div>
